...
This is a YSWS I designed where if you design a project (website, game, tool, etc.) which benefits students in school, you get Japanese stationery shipped to you. Some examples of projects are websites for clubs/teams, digital flashcards, review games, and timetables. I designed this because I enjoy trying out different pens and pencils. I imagine other Hack Clubbers probably also enjoy this as well, so I though about creating a YSWS for it (also even though it is mentioned on the website, I haven't actually created a Slack channel for it yet).  
...
I used mainly HTML and CSS to build the website. I previously had JavaScript drop downs for the FAQs, but I removed them afterward because I felt that it didn't really match the entire website. I also didn't really understand how the CSS and JavaScript worked together, so it didn't feel right to include it.  

The most challenging aspect of creating this website was structuring it how I pictured it to be. Compared to some other websites that I made, this involved more attention to detail since its purpose was to grab the attention of others in an effort to persuade them. Although I had some idea of how to do this (got experience through building my personal website), I ended up taking more time than I hoped on some sections. 
